...
INSERT INTO "new_Cars" ("advertisement_status", "brand_id", "carColor", "car_status", "created_at", "description", "doors", "drive", "engine", "fuel", "id", "mileage", "model_id", "power", "price", "seats", "title", "transmission", "type", "updated_at", "views", "year") SELECT "advertisement_status", "brand_id", "carColor", "car_status", "created_at", "description", "doors", "drive", "engine", "fuel", "id", "mileage", "model_id", "power", "price", "seats", "title", "transmission", "type", "updated_at", "views", "year" FROM "Cars";
DROP TABLE "Cars";
