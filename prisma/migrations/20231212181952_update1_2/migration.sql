/*
  ...
  - You are about to alter the column `price` on the `Cars` table. The data in that column could be lost. The data in that column will be cast from `Decimal` to `Int`.
