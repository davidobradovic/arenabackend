...
INSERT INTO "new_Cars" ("advertisement_status", "brand_id", "carColor", "car_status", "description", "drive", "engine", "fuel", "id", "mileage", "model_id", "power", "price", "title", "transmission", "type", "year") SELECT "advertisement_status", "brand_id", "carColor", "car_status", "description", "drive", "engine", "fuel", "id", "mileage", "model_id", "power", "price", "title", "transmission", "type", "year" FROM "Cars";
DROP TABLE "Cars";
